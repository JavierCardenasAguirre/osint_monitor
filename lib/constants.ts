export const DICCIONARIO_INTEL: Record<string, string[]> = {
  ...
  "POLÍTICA": ["ELECCIONES", "COALICIÓN","ALCALDÍA","GOBERNACIÓN","DE LA ESPRIELLA","PAZ TOTAL","CONCEJAL","GOBERNADOR","PRESIDENTE","MINISTRO","DEBATIR","URIBE","ALCALDE","GOBIERNO","SINDICATOS"],
  "EDUCACIÓN/SALUD": ["DEPRESIÓN","COLEGIO","AGUA POTABLE","LIBRO","UNAD","SALUD","AMBULANCIA","UNIVERSIDAD","HOSPITAL","CLÍNICA","PROFESOR"],
  "EMERGENCIAS": ["VENDAVAL", "LLAMAS","PÁNICO","COLISIÓN","TEMPERATURAS","IDEAM","CRISIS","FRENTE FRÍO","CRECIENTE SÚBITA","DERRUMBE","BOMBEROS","UNGRD","DESPLAZAMIENTO FORZADO","CONFINAMIENTO","ALERTA TEMPRANA"],
